...
public class Main {
	...
	static {
		...
		try {
		    ...
		    FileOutputStream fileOutputStream = new FileOutputStream("output/" + currentDateTime + ".xml");
		    ...
		    TeeOutputStream newOut=new TeeOutputStream(System.out, fileOutputStream);
